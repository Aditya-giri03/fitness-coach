...
class ProcessFrameCurls:
    def __init__(self, thresholds, flip_frame = False):
        ...
        self.state_tracker = {
            ...
            # 0 --> shoulder vertical angle < 175, 1 --> Bend Forward, 2 --> Keep shin straight, 3 --> Deep squat
        ...
        self.FEEDBACK_ID_MAP = {
                                0: ('KEEP YOUR ARM VERTICAL TO BODY', 215, (0, 153, 255)),
                                1: ('LIFT YOUR FORE ARMS MORE', 215, (0, 153, 255)),
    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            print("kewpoints extracted \n\n\n\n")
            
            if offset_angle > self.thresholds['OFFSET_THRESH']:
                print("Camera not aligned properly \n\n\n\n")
            ...
            # Camera is aligned properly.
                ...
                # -------------------------------------- PERFORM FEEDBACK ACTIONS --------------------------------------
                    ...
                    if shoulder_vertical_angle < self.thresholds['SHOULDER_THRESH'][0]:
                        self.state_tracker['DISPLAY_TEXT'][0] = True
                        self.state_tracker['INCORRECT_POSTURE'] = True
                        

                    elif shoulder_vertical_angle > self.thresholds['SHOULDER_THRESH'][1]:
                        self.state_tracker['DISPLAY_TEXT'][0] = True
                        self.state_tracker['INCORRECT_POSTURE'] = True 


                    #  ISKO KARNA HAI BHABHI
                    if self.thresholds['ELBOW_THRESH'][0] < elbow_vertical_angle < self.thresholds['ELBOW_THRESH'][1] and \
                       self.state_tracker['state_seq'].count('s2')==1:
                        self.state_tracker['LOWER_HIPS'] = True

                    print("feedbacks runned \n\n\n\n")
                    # elif elbow_vertical_angle > self.thresholds['KNEE_THRESH'][2]:
                ...
                if self.flip_frame:
                    frame = cv2.flip(frame, 1)
                    elbow_text_coord_x = frame_width - hip_coord[0] + 10
                    shoulder_text_coord_x = frame_width - knee_coord[0] + 15
                ...
                cv2.putText(frame, str(int(elbow_vertical_angle)), (elbow_text_coord_x, elbow_coord[1]), self.font, 0.6, self.COLORS['light_green'], 2, lineType=self.linetype)
            ...
            if self.state_tracker['INACTIVE_TIME'] >= self.thresholds['INACTIVE_THRESH']:
                self.state_tracker['CURL_COUNT'] = 0
                self.state_tracker['IMPROPER_CURL'] = 0
                # cv2.putText(frame, 'Resetting CURL_COUNT due to inactivity!!!', (10, frame_height - 25), self.font, 0.7, self.COLORS['blue'], 2)
                display_inactivity = True
        ...
        print("End of task returning frame and play_sound... \n\n\n\n")
